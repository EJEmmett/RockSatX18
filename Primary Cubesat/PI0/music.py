...
mixer.music.play()
sleep(180)
o.write(log[2] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)

o.write(log[3] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)
mixer.music.load(file2)
mixer.music.play()
sleep(180)
o.write(log[4] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)

o.write(log[5] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)
mixer.music.load(file3)#the ONE rap song...
mixer.music.play()
sleep(180)
o.write(log[6] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)

o.write(log[7] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)
mixer.music.load(file4)
mixer.music.play()
sleep(180)
o.write(log[8] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)

o.write(log[9] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)
mixer.music.load(file5)
mixer.music.play()
sleep(180)
o.write(log[10] + time.strftime('%H:%M:%S') + '\n')
sleep(0.1)
o.write(log[11] + time.strftime('%H:%M:%S') + '\n')
